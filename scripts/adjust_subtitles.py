...
def generate_ass_from_file(input_path, output_path, project_folder, 
                           ...
                           font, outline_color, shadow_color, bold, italic, underline, 
                            ...
                            face_modes={}, remove_punctuation=True, margin_l=80, margin_r=80):
    """
    ...
    if os.path.exists(renamed_timeline_path):
        try:
            ...
            print(f"[WARN] Failed to load renamed timeline '{renamed_timeline_path}': {e}")
    ...
    if not timeline_data and idx is not None:
         ...
         if os.path.exists(csv_timeline):
             try:
                 ...
                 print(f"[WARN] Failed to load fallback timeline '{csv_timeline}': {e}")
    ...
    Style: Default,{font},{base_size},{base_color},&H00000000,{outline_color},{shadow_color},{bold},{italic},{underline},{strikeout},100,100,0,0,{border_style},{outline_thickness},{shadow_size},{alignment},{margin_l},{margin_r},{vertical_position},1
...
def adjust(base_color, base_size, highlight_size, highlight_color, words_per_block, gap_limit, mode, vertical_position, alignment, font, outline_color, shadow_color, bold, italic, underline, strikeout, border_style, outline_thickness, shadow_size, uppercase=False, project_folder="tmp", margin_l=80, margin_r=80, **kwargs):
    ...
    for filename in os.listdir(input_dir):
        if filename.endswith(".json"):
            ...
            generate_ass_from_file(input_path, output_path, project_folder, 
                           ...
                           font, outline_color, shadow_color, bold, italic, underline, 
                           strikeout, border_style, outline_thickness, shadow_size, uppercase,
                           face_modes, remove_punctuation, margin_l, margin_r)
